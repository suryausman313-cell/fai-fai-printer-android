...
public class MainActivity extends Activity {
    private static final String KITCHEN_URL =
            "https://fai-fai-juice.pages.dev/kitchen";

    private final ExecutorService printerExecutor =
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setUserAgentString(
                settings.getUserAgentString() + " FaiFaiPrinter/1.0"
        );
